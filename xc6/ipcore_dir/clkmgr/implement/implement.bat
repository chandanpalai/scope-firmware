...
xst -ifn xst.scr
move clkmgr_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\clkmgr.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkmgr.ucf clkmgr_exdes

echo 'Running map'
map -timing -pr b clkmgr_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clkmgr_exdes -w routed.ncd routed.vhd
cd ..
