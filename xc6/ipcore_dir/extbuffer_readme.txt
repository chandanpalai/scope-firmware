...
/home/ali/Projects/Active/cur/usbscope/fw/xc6/ipcore_dir:
   ...
   - extbuffer.gise and extbuffer.xise:
        ISE Project Navigator support files. These are generated files and
        should not be edited directly.

   - extbuffer directory.

In the extbuffer directory, three folders are created:
   - docs:
