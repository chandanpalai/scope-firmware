...
xst -ifn xst.scr
move maindcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\maindcm.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc maindcm.ucf maindcm_exdes

echo 'Running map'
map -timing -pr b maindcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm maindcm_exdes -w routed.ncd routed.vhd
cd ..
