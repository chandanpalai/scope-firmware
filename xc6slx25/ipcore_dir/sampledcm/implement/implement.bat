...
xst -ifn xst.scr
move sampledcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\sampledcm.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc sampledcm.ucf sampledcm_exdes

echo 'Running map'
map -timing -pr b sampledcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm sampledcm_exdes -w routed.ncd routed.vhd
cd ..
