...
xst -ifn xst.scr
move samplepll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\samplepll.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc samplepll.ucf samplepll_exdes

echo 'Running map'
map -timing -pr b samplepll_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm samplepll_exdes -w routed.ncd routed.vhd
cd ..
